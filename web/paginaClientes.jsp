                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <br>
                                <p id="txtSearchFailed" style="display: none; font-size: 30px ">No se encontro el cliente</p>
                                <table id="tabla2" class="content-table" border="5">
                                    ...
                                    <tbody>
                                        <c:forEach var="u" items="${listaClientes}">
                                            <tr>
                                                <td>${u.cedula}</td>
                                                <td>${u.nombre}</td>
                                                <td>${u.apellido}</td>
                                                ...
                                                <td style="text-align: center">
                                                    <button class="btn-danger btnEliminar" data-params="${u.id_usuario},${u.nombre},2">&#x2716 Eliminar</button><br><br>
                                                    <form action="Controlador" method="POST">
                                ...
                                <a type="submit" class="nva-pag" href="Controlador?accion=formularioCliente">&#x271a Añadir Cliente</a>
                                </p>
                            </div>
                        </div>
